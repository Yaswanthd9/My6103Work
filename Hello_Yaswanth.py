...
print(cnt, ". I want to say",astring )
cnt+=1
print("%d. I want to say %s, my cutie %.3f" % (cnt,astring,anum) )
cnt+=1
print("%d. I want to say %s, my cutie digit %d" % (cnt,astring,anum) )
cnt+=1
print("%d. I want to say %s, my cutie long %f" % (cnt,astring,anum) )
cnt+=1
